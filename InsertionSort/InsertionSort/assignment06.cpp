...
void testInsert()
{
   ...
   try
   {
      ...
      Node <int> * n = NULL;
      n = insert(20, n);  // assign a new head to n
      ...
      n = insert(10, n); // assign a new head to n
      ...
      n = insert(5, n); // assign a new head to n
      cout << "\t{ " << n->data
           << ", "<< n->pNext->data
           << ", "<< n->pNext->pNext->data
           << ", "<< n->pNext->pNext->pNext->data
...
void testLoop()
{
   ...
   try
   {
      ...
      n = insert('c', n, true);            // { c } 
      insert('d', n, true);                // { c, d }
      insert('f', n->pNext, true);         // { c, d, f }
      n = insert('b', n);                  // { b, c, d, f }
      insert('e', n->pNext->pNext->pNext); // { b, c, d, e, f }
      n = insert('a', n);                  // { a, b, c, d, e, f }
      ...
      n = insert('Y', n, true);              // { Y }
      n = insert('Z', n, false);             // { Z, Y }
      insert('V', n->pNext, true);           // { Z, Y, V }
      insert('U', n->pNext->pNext, true);    // { Z, Y, V, U }
      insert('X', n->pNext->pNext);          // { Z, Y, X, V, U }
      insert('W', n->pNext->pNext, true);    // { Z, Y, X, W, V, U }
